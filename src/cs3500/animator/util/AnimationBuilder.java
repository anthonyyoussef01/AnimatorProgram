...
/**
 * A Builder interface for the Animator.
 *
 * @param <Doc> the type of Document being built (in the model it's implemented as an
 *              AnimatorModel).
 */
public interface AnimationBuilder<Doc> {
  ...
  /**
   * Adds a slomo interval to the growing document.
   *
   * @param ints an int[2] representing the start and end tick of the slomo interval.
   * @return This {@link AnimationBuilder}
   */
  AnimationBuilder<Doc> addSlomoInterval(int[] ints);
